...
<body class="bg-[#FFFAF0] text-gray-900 overflow-x-hidden selection:bg-[#C19A6B] selection:text-white" x-data="landing">
    ...
    <div class="fixed top-20 left-10 w-96 h-96 bg-[#C19A6B]/10 rounded-full blur-[100px] pointer-events-none z-[-1]"></div>
    <div class="fixed bottom-20 right-10 w-[500px] h-[500px] bg-yellow-600/5 rounded-full blur-[120px] pointer-events-none z-[-1]"></div>
    ...
    <nav :class="{ 'bg-white/90 backdrop-blur-md shadow-sm border-b border-gray-100': scrolled, 'bg-transparent': !scrolled }" class="fixed w-full z-50 transition-all duration-300 top-0">
        <div class="max-w-7xl mx-auto px-6 h-24 flex justify-between items-center">
            ...
            <!-- Desktop Menu -->
            <div class="hidden md:flex items-center space-x-8 rtl:space-x-reverse font-bold text-gray-600">
    ...
    <section class="relative pt-36 pb-24 lg:pt-48 lg:pb-32 overflow-hidden">
        <div class="max-w-7xl mx-auto px-6 grid lg:grid-cols-2 gap-12 items-center relative z-10">
            ...
            <div class="relative h-[500px] hidden lg:block">
                <!-- Card 1: WhatsApp -->
                <div class="absolute top-10 right-10 float-1 glass-card p-4 rounded-2xl shadow-2xl flex items-center gap-4 w-72" x-data="{ names: ['Ahmed', 'Sarah', 'Khalid'], idx: 0 }" x-init="setInterval(()=>idx=(idx+1)%3, 3000)">
                ...
                <!-- Card 2: RSVP Status -->
                <div class="absolute top-1/2 left-0 -translate-y-1/2 float-2 glass-card p-4 rounded-2xl shadow-2xl border-l-4 border-green-500 flex items-center gap-4 w-72" x-data="{ statuses: [{n:'Noura', s:'confirmed'},{n:'Maha', s:'apologized'}], idx: 0 }" x-init="setInterval(()=>idx=(idx+1)%2, 3500)">
                ...
                <!-- Card 3: QR Entry -->
                <div class="absolute bottom-10 right-20 float-3 bg-gray-900 p-4 rounded-2xl shadow-2xl border border-gray-800 flex items-center gap-4 w-64">
    ...
    <section class="py-24 bg-white/50 backdrop-blur-md border-y border-gray-100 relative">
        <div class="max-w-7xl mx-auto px-6">
            ...
            <div class="grid md:grid-cols-3 gap-12 relative">
                <div class="hidden md:block absolute top-12 left-1/6 right-1/6 h-0.5 bg-gradient-to-r from-[#FFFAF0] via-[#C19A6B] to-[#FFFAF0] z-0 opacity-30"></div>
