...
<head>
    ...
    <style>
        :root {
            --moon-color: rgba(200, 220, 255, 0.15); /* Cold silver/blue moon */
        }
        ...
        #moon-light {
            ...
            opacity: 0; /* Hidden initially until Hero passes */
        }
        ...
        /* Curtain Reveal */
        .curtain-reveal {
            clip-path: inset(0 50% 0 50%); /* Starts fully closed horizontally */
        ...
        /* Space background for countdown */
        .space-bg {
...
<body x-data="moonlightData()" x-init="initExperience()">
    ...
    <!-- Global Moon Light Source -->
    <div id="moon-light"></div>

    <!-- Scene 1: Loader -->
    <div id="loader">
        <h1 class="font-royal text-3xl md:text-4xl text-gray-400 opacity-0 tracking-widest" id="bismillah-text">
    ...
    <div id="main-content">
        ...
        <section class="h-[120vh] relative flex flex-col justify-center items-center text-center px-4" id="hero-section">
            <div class="sticky top-[35vh] w-full max-w-4xl">
                <h2 class="font-royal text-6xl md:text-8xl text-white drop-shadow-2xl flex flex-col justify-center items-center gap-6">
                    ...
                    <div id="hero-amp" class="opacity-0 text-3xl text-gray-400">&</div>
            ...
            <section class="section-dark py-[30vh] px-4 min-h-screen flex items-center" id="story-section">
                <div class="max-w-3xl mx-auto text-center space-y-24">
                    <template x-for="(line, idx) in splitLines(data.story_content)" :key="idx">
                        <p class="font-royal text-3xl md:text-5xl leading-relaxed text-gray-200 gs-story-line opacity-0" x-text="line"></p>
                    </template>
                </div>
            </section>
        </template>

        <!-- Scene 4: Polaroid Gallery -->
            ...
            <section class="section-dark py-[20vh] px-4" id="gallery-section">
                <div class="polaroid-wrapper">
                    <template x-for="(img, idx) in data.gallery.slice(0, 3)" :key="idx">
                        <!-- We manually stagger positions to look like scattered polaroids -->
                        <div class="polaroid" 
        ...
        <section class="section-dark py-[30vh] px-4 flex justify-center" id="invitation-section">
            <div class="glass-card p-12 md:p-20 max-w-2xl text-center gs-fade-up">
                <p class="font-royal text-4xl md:text-5xl leading-loose text-white mb-8">
                    يشرفنا حضوركم<br>ومشاركتنا فرحتنا
                </p>
                <div class="w-12 h-px bg-white/30 mx-auto"></div>
            </div>
        </section>

        <!-- Scene 6: Curtain Reveal Venue -->
        <template x-if="data.venue_name">
            <section class="section-dark py-[20vh] px-4 relative flex flex-col items-center" id="venue-section">
                <h3 class="font-royal text-2xl text-gray-500 mb-12 gs-fade-up tracking-widest">مكان اللقاء</h3>
                ...
                <div class="mt-16 gs-fade-up">
                    <template x-if="data.map_link">
                        <a :href="data.map_link" target="_blank" class="inline-flex items-center gap-3 text-white border-b border-white/30 pb-1 hover:border-white transition text-lg tracking-wider">
                            عرض الموقع
        ...
        <section class="section-dark py-[25vh] px-4 text-center relative overflow-hidden" id="countdown-section">
            ...
            <div class="relative z-10 gs-fade-up">
                <div class="moon-graphic mb-16 relative">
                    <!-- Overlay text on moon if desired, but keep it clean -->
                </div>
                ...
                <div class="flex justify-center gap-8 md:gap-16 dir-ltr" style="direction: ltr;">
                    <div class="text-center">
                        ...
                        <div class="text-sm tracking-widest text-gray-500">يوماً</div>
                    </div>
                    <div class="text-center">
                        <div class="text-5xl md:text-7xl font-light mb-2 text-white" x-text="timeLeft.hours">00</div>
                        <div class="text-sm tracking-widest text-gray-500">ساعة</div>
                    </div>
                    <div class="text-center">
                        <div class="text-5xl md:text-7xl font-light mb-2 text-white" x-text="timeLeft.minutes">00</div>
                        <div class="text-sm tracking-widest text-gray-500">دقيقة</div>
                    </div>
                </div>
            </div>
        </section>

        <!-- Scene 8 & 9: Personal Message & Luminous RSVP -->
        <section class="section-dark py-[20vh] px-4 relative flex justify-center" id="rsvp-section">
            <div class="w-full max-w-xl text-center relative z-10 gs-fade-up">
                ...
                @if(isset($guest) && $guest)
                    <p class="font-royal text-3xl text-gray-400 mb-4 tracking-wider">مرحباً {{ $guest->name ?? '' }}</p>
                    <h2 class="font-royal text-4xl md:text-5xl mb-16 text-white leading-tight">لقد خصصنا هذه الدعوة لك</h2>
                @else
                    <h2 class="font-royal text-4xl md:text-5xl mb-16 text-white">تأكيد الحضور</h2>
                @endif
                ...
                <div class="glass-card p-10 md:p-14 relative" id="rsvp-card">
                    ...
                    <div x-show="rsvpStatus === 'success'" class="absolute inset-0 flex flex-col items-center justify-center bg-black/90 backdrop-blur-md rounded-2xl z-20" style="display: none;">
                        <h3 class="font-royal text-4xl text-[#d4af37] mb-4">تم تأكيد حضورك</h3>
                        <p class="text-gray-400 text-lg">بانتظارك في ليلتنا الموعودة.</p>
                    </div>
        ...
        <footer class="section-dark py-[30vh] text-center relative">
            ...
            <div class="relative z-10 gs-fade-up">
                <template x-if="data.closing_message">
                    <p class="font-royal text-3xl md:text-4xl text-gray-400 mb-16" x-text="data.closing_message"></p>
                </template>
                <template x-if="!data.closing_message">
                    <p class="font-royal text-3xl md:text-4xl text-gray-400 mb-16">وجودكم سيجعل ليلتنا أكثر جمالاً</p>
                </template>
    ...
    <script>
        function moonlightData() {
            return {
                ...
                startExperience() {
                    ...
                    // Cinematic Names Reveal (Character by Character)
                    const tl = gsap.timeline();
                ...
                initScrollEngine() {
                    const lenis = new Lenis({
                        duration: 1.8, // Very slow and smooth for cinematic feel
                    ...
                    if(polaroids.length > 0) {
                        polaroids.forEach((p, i) => {
                            gsap.to(p, {
                                y: -150 - (i * 50), // Move up at different speeds
                                ease: "none",
                                scrollTrigger: {
        ...
        // RSVP Intercept for Golden Moon Effect
        document.addEventListener('DOMContentLoaded', () => {
            ...
            if(form) {
                form.addEventListener('submit', (e) => {
                    ...
                    // Show success manually for visual feedback
                    // Real submission happens natively unless prevented, but we allow it to submit
                });
            }
        });
    </script>
