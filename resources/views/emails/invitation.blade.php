...
<head>
    ...
    <title>دعوة خاصة - {{ $invitation->event->title }}</title>
    <style>
        ...
        .details-box { text-align: center; margin-bottom: 30px; }
    ...
    <div class="wrapper">
        <div class="card">
            <div class="inner-border">
                ...
                <p class="message">
                    نتشرف بدعوتكم لمشاركتنا لحظاتنا السعيدة في هذه المناسبة الخاصة.<br>
                    حضوركم يضاعف فرحتنا ويكمل بهجتنا.
                </p>
                ...
                <div class="btn-container">
                    <a href="{{ url('/i/' . $invitation->uuid) }}" class="btn">عرض تفاصيل الدعوة</a>
                </div>
                
                <p class="message" style="font-size: 14px; color: #888;">
                    نرجو التكرم بالدخول للرابط لتأكيد الحضور أو الاعتذار ليتسنى لنا إكمال الترتيبات.
                </p>
            </div>
        </div>
        <div class="footer">
